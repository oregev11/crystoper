...
def parse_args():
    ...
    parser.add_argument('-u', '--update-ids', action='store_true', help='Fetch and overwrite the pdbs ids list json file using PDB search query')
    parser.add_argument('-up', '--update-pe', action='store_true', help='Fetch and overwrite the polymer-entities list json file of the using PDB search query')
